...
import { RechargementTable } from '../components/Tables';
import { useState } from 'react';
import { ModalRechargement } from './components/Modals';
...
export default () => {
  ...
  return (
    <>
      <ModalRechargement
        showRechargeModal={showModalRecharge}
        closeRechargeModal={() => setShowModalRecharge(false)}
      />
      <div className='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4'>
        <div className='d-block mb-4 mb-md-0'>
          <h4>Portefeuilles</h4>
          <p className='mb-0'>La liste des opérations.</p>
        </div>
        <Button
          variant='primary'
